...
const Chat: VoidComponent = () => {
  ...
  const server = trpc.messages.getServer.useQuery(() => ({ id: serverId }));
  ...
  const createServer = trpc.messages.createServer.useMutation();
  const createChannel = trpc.messages.createChannel.useMutation();
